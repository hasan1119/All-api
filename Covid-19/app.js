...
function getData(country) {
    ...
    <div class="card-body">
        <h5 class="card-title text-white text-center mb-3">Country Name: ${latestUpdate.Country} </h5>
        <hr>
        <h6 class="card-subtitle mb-2 text-secondary">Confirmed: ${latestUpdate.Confirmed} </h6>
        <h6 class="card-subtitle mb-2 text-success">Active: ${latestUpdate.Active}</h6>
        <h6 class="card-subtitle mb-2 text-warning">Deaths: ${latestUpdate.Deaths} </h6>
        <h6 class="card-subtitle mb-2 text-primary">Date:${latestUpdate.Date.slice(0,10)}  </h6>
